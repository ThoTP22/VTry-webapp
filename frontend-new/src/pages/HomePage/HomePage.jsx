...
const HomePage = () => {
  ...
  const heroCollections = [
    {
      ...
      description:
        "Discover our curated selection of autumn essentials, crafted with the finest materials and attention to detail.",
      image:
        "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=800&h=1000&fit=crop&crop=center",
    ...
    },
    {
      ...
      description:
        "Experience the future of fashion with our revolutionary virtual try-on technology.",
      image:
        "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=800&h=1000&fit=crop&crop=center",
  ...
  const luxuryFeatures = [
    ...
    },
    {
      ...
      description:
        "Limited edition pieces from world-renowned designers and emerging talents",
    },
    {
      icon: <GiftOutlined className="text-3xl text-accent-500" />,
      title: "Personalized Service",
      description:
        "Dedicated styling consultants and tailored shopping experiences",
    },
  ];
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-xl lg:text-2xl leading-relaxed text-gray-200 max-w-2xl">
                    Discover our exclusive collection of luxury fashion with
                    innovative virtual try-on technology. Experience
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isLoading ? (
            <div className="text-center py-20">
              <Spin size="large" />
              <p className="mt-4 text-luxury-darkgrey">
            ...
            <Row gutter={[32, 48]}>
              {featuredProducts.length > 0 ? (
                          ...
                          <div className="relative overflow-hidden aspect-[3/4]">
                            ...
                            {product.status && (
                              <div className="absolute top-4 left-4 space-y-2">
                                <div
                                  className={`px-3 py-1 rounded-full text-xs font-medium text-white uppercase tracking-wide ${
                ...
                <Col span={24}>
                  <div className="text-center py-20">
                    <p className="text-luxury-darkgrey text-lg">
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Every detail crafted to perfection, every experience tailored to
              exceed expectations
            </p>
          </div>
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-12 leading-relaxed">
              Be the first to discover our new collections, exclusive events,
