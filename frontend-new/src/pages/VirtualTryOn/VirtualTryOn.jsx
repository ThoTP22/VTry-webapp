        ...
        if (data.userPhoto) {
          ...
          setTimeout(() => {
            ...
            if (data.product && data.userPhoto) {
              ...
              axios
                .post(API_ENDPOINTS.VIRTUAL_TRYON.TRYON, formData, { headers })
                .then((response) => {
    ...
    async function fetchProducts() {
      try {
        ...
        if (Array.isArray(products)) {
          console.log(
            "✅ Setting products array directly:",
            products.length,
            "items"
          );
          ...
          console.log(
            "✅ Setting products from .result property:",
          ...
          console.log(
            "✅ Setting products from .products property:",
          ...
          console.log(
            "✅ Setting products from .data property:",
  ...
  return (
    <div className="min-h-screen bg-luxury-white">
      ...
      <div className="w-full bg-gradient-to-br from-luxury-black via-luxury-darkgrey to-luxury-black text-luxury-white py-20" 
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6">
            ...
            <Title
              level={1}
              className="text-4xl md:text-6xl font-serif font-light !text-luxury-white !mb-0"
            >
              Virtual Try-On Experience
            </Title>
            <Text className="text-xl text-luxury-white/80 font-light max-w-3xl mx-auto block">
              Experience the future of luxury fashion with our AI-powered
              virtual try-on technology. See how our curated pieces look on you
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Progress Steps */}
        <div className="mb-16">
          <Steps current={currentStep} className="luxury-steps" size="default">
        ...
        <Row gutter={[48, 48]} className="min-h-[600px]">
                  ...
                  <Row gutter={[16, 16]}>
                    {luxuryProducts.map((product) => (
                      <Col xs={12} sm={6} key={product._id || product.id}>
                        <Card
                          hoverable
                          className={`luxury-product-selector ${
              ...
              {currentStep === 2 && (
                <div className="text-center space-y-8">
                  ...
                  <div className="bg-luxury-lightgrey/50 p-6 rounded-luxury">
                    <Title
                      level={5}
                      className="text-center !mb-4 !text-luxury-black"
                    >
                      Try-On Settings
                    </Title>
                    ...
                    <div className="space-y-4">
                      <div className="text-left">
                        <Text className="block mb-2 text-luxury-darkgrey">
                          Chất lượng xử lý:
                        </Text>
                        <Radio.Group
                          value={tryOnMode}
                    ...
                    <Space size="middle" wrap>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (selectedProduct) {
                            message.success(
                              `${selectedProduct.name} has been added to the cart!`
                            );
                          }
                        }}
                      >
          ...
          <Col xs={24} lg={12}>
            ...
            >
              <div
                className="h-full bg-luxury-lightgrey rounded-luxury flex items-center justify-center relative overflow-hidden"
                  ...
                  <div className="absolute inset-0 w-full h-full">
                    {isFetchingImage && (
                      <div className="absolute inset-0 flex items-center justify-center bg-luxury-lightgrey/80 z-10">
                        <div className="text-center">
                          <Spin size="large" />
                          <p className="mt-3 text-luxury-darkgrey">
                      ...
                      <div className="absolute inset-0 bg-red-50 bg-opacity-95 flex flex-col items-center justify-center p-6 text-red-700">
                        <div className="max-w-md text-center space-y-4">
                          ...
                          <div className="text-sm">
                            The image was processed successfully but cannot be
                            displayed inline.
                          </div>
                          ...
                          <div className="border border-gray-300 p-2 bg-white rounded">
                            ...
                            <img
                              ...
                              onError={() =>
                                console.log("❌ Direct URL test failed")
                              }
                            />
                          </div>
                          ...
                          <div className="grid grid-cols-1 gap-2 w-full">
                            <Button
                              onClick={() =>
                                window.open(tryOnResultRaw, "_blank")
                              }
                              type="primary"
                              size="small"
                              className="w-full"
                            ...
                            <Button
                              onClick={async () => {
                                try {
                                  ...
                                  let response;
                                  try {
                                    response = await fetch(tryOnResultRaw, {
                                      mode: "cors",
                                    });
                                  } catch (corsErr) {
                                    console.log(
                                      "CORS failed, trying no-cors..."
                                    );
                                    response = await fetch(tryOnResultRaw, {
                                      mode: "no-cors",
                                    });
                                  ...
                                  message.error(
                                    'Blob method failed. Try "Open in new tab".'
                                  );
                                }
                              }}
                              size="small"
